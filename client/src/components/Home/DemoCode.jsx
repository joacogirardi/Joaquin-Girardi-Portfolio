...
export default function DemoCode() {
  const underBuild = () => {
    swal.fire("feature under construction");
  };
          ...
          >
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header" style={{"background-color":"black","color": "#9f9f9f"}}>
                ...
                <div class="modal-body" id="infoHomeModal">
                  ...
                  <p>you can send me an email to<span><a href="mailto:joacojoacog@gmail.com?subject=Email%20sent%20from%20portfolio&body=Hello!%20I%20communicate%20from..."> my address</a> or</span></p>
                  <p>Leave your email here, and i will contact as soon as i can</p>
                  <div style={{"display": "flex"}}>
                  <input placeholder="your email adress"></input><button onClick={emailSubmit} className="btn btn-success">send</button>
                  </div>
                  <small style={{"margin-top":"4px"}}>You can also download my <a href="https://drive.google.com/drive/folders/1b2_6JwyAzeHAVl6t4kOMQCk60pUEfHEV?usp=sharing">CV</a></small>
