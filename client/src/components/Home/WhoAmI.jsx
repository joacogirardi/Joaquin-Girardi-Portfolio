      ...
      <div className="container aboutJoacoMain">
        <div className="row">
          <div className="col-12">
            <h2 className="WhoIsJoaco">Who I Am?</h2>
            <p className="TechInfo">
              Born in Chubut, currently residing in Cordoda - Argentina. I am a
              full stack web programmer. I enjoy rubbing elbows with the company
